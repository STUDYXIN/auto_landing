    ...
    while (ros::ok())
    {
        ...
        if(mymode == 1)
        {
            ...
            else
            {
                forward = Kp * (tfStamped.transform.translation.x - local_pose.pose.position.x);
                leftward = Kp * (tfStamped.transform.translation.y - local_pose.pose.position.y);
                upward = Kp * (tfStamped.transform.translation.z - local_pose.pose.position.z + track_height);
        ...
        else if (mymode == 2)
        {
            forward = Kp * (tfStamped.transform.translation.x - local_pose.pose.position.x);
            leftward = Kp * (tfStamped.transform.translation.y - local_pose.pose.position.y);
            upward = Kp * (tfStamped.transform.translation.z - local_pose.pose.position.z);
