...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber cmd_sub = nh.subscribe<mavros_msgs::AttitudeTarget>("/mavros/setpoint_raw/attitude",1,CmdCallbackFunc);
    ros::Subscriber ground_truth_sub = nh.subscribe<nav_msgs::Odometry>("/mavros/local_position/odom",1,odomCallbackFunc);
